...
Paquetes como `sp`, `rgdal`, `rgeos` y `maptools` (*Bivand, Keitt y Rowlingson, 2023 - Bivand y Rundel, 2022 - Bivand y Lewin-Koh, 2022*) se ocupaban de los datos especiales y de conectar con la librería **GDAL**. 

No eran compatibles con tidyverse y su diseño interno mas complejo. 

Ya no se mantienen, es decir perdieron soporte, y proximamente se retirarán. 
